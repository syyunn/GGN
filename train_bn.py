...
parser.add_argument(
    "--epoch_num", type=int, default=10, help="number of epochs to train"
)
parser.add_argument(
    "--batch-size",
    type=int,
...
parser.add_argument(
    "--experiments", type=int, default=10, help="number of experiments (default: 10)"
)
parser.add_argument(
    "--dynamics-steps",
    type=int,
...
for epoch in range(Epoch_Num):
    ...
    for batch_idx, (data_val, data_target) in enumerate(valid_data_loader):
        if use_cuda:
            ...
            data_target = data_target.cuda()
        val_loss = get_valid_loss(
            gumbel_generator, dyn_learner, data_val, data_target, loss_fn
        )
